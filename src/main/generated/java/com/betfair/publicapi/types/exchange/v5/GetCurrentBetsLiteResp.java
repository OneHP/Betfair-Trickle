...
/**
 * <p>Java class for GetCurrentBetsLiteResp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetCurrentBetsLiteResp">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.betfair.com/publicapi/types/exchange/v5/}APIResponse">
 *       &lt;sequence>
 *         &lt;element name="betLites" type="{http://www.betfair.com/publicapi/types/exchange/v5/}ArrayOfBetLite"/>
...
@XmlType(name = "GetCurrentBetsLiteResp", propOrder = {
    "betLites",
    "errorCode",
    "minorErrorCode",
    "totalRecordCount"
})
public class GetCurrentBetsLiteResp
    extends APIResponse
{

    @XmlElement(required = true, nillable = true)
    protected ArrayOfBetLite betLites;
     ...
     *     
     */
    public ArrayOfBetLite getBetLites() {
        return betLites;
    }
     ...
     *     
     */
    public void setBetLites(ArrayOfBetLite value) {
        this.betLites = value;
    }
