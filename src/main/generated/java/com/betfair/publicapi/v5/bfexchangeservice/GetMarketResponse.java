 ...
 *       &lt;sequence>
 *         &lt;element name="Result" type="{http://www.betfair.com/publicapi/types/exchange/v5/}GetMarketResp"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetMarketResponse {
    ...
    protected GetMarketResp result;
     ...
     *     
     */
    public GetMarketResp getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(GetMarketResp value) {
        this.result = value;
    }
